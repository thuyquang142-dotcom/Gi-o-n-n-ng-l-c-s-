...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Nam Thùy - Trường Tiểu họcHùng An - ĐT: 0986411187</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Nam Thùy - Trường Tiểu học Hùng An - ĐT: 0986411187</div>", unsafe_allow_html=True)
